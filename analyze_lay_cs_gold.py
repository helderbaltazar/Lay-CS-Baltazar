...
strategies = []
strategies.append(test_strategy(df, "Gold: Home xG > 1.5, BTTS > 0.6, Odd Home < 2.0, Lay Odd < 15", 
                                (df['team_a_xg_prematch'] > 1.5) & (df['Potencial BTTS'] > 0.6) & (df['odd_h'] < 2.0) & (df['lay_odd'] <= 15)))
