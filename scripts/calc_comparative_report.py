...
# Calculate Power Score for everything
...
print_report("1. O SUPER FILTRO (Power Score >= 30 + SomaHT <= 1.2 + Efic_xG <= 1.0 + Odd >= 2.70)", mask_super)

# 2. Apenas Power Score >= 30
mask_ps_only = (df['Power_Score'] >= 30)
print_report("2. APENAS POWER SCORE >= 30 (Sem olhar Odd, xG ou Histórico HT)", mask_ps_only)
